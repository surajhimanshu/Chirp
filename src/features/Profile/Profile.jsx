...
import { getIndividualUserPostsApi, getIndividualUserProfileApi } from "./profile.api";
  ...
  return (
    <div className={styles.profile_wrapper}>
      ...
      <div className={styles.descript_container}>
        ...
        <div style={{ fontWeight: "400", fontSize: "0.8em",    marginBottom: "7px" }}>
      ...
      <div>
        {posts.map((post) => <IndividualUserPost key ={post.id} post = {post}/>) }
      </div>
    </div>
  );
};
